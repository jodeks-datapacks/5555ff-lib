$dialog show @s {\
  ...
  "exit_action": {\
    ...
    "action": {\
      ...
      "template": "function jodek:config/save/too_expensive_removed {dialog_load_message:$(dialog_load_message), dialog_advancements:$(dialog_advancements)}"\
    }\
  },\
  "columns": 1,\
  "actions": [\
    {\
      ...
      "action": {\
        ...
        "command": "function jodek:app/uninstall/too_expensive_removed"\
      }\
    },\
    {\
      "label": "Modrinth",\
      "action": {\
        ...
        "url": "https://modrinth.com/datapack/too-expensive-removed"\
      }\
    }\
  ]\
}