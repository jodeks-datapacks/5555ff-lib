$dialog show @s {\
  ...
  "exit_action": {\
    ...
    "action": {\
      ...
      "template": "function jodek:config/save/better_cutter {dialog_load_message:$(dialog_load_message), dialog_advancements:$(dialog_advancements)}"\
    }\
  },\
  "columns": 1,\
  "actions": [\
    {\
      ...
      "action": {\
        ...
        "command": "function jodek:app/uninstall/better_cutter"\
      }\
    },\
    {\
      "label": "Modrinth",\
      "action": {\
        ...
        "url": "https://modrinth.com/datapack/better-cutter"\
      }\
    }\
  ]\
}