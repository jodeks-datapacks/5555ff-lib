$dialog show @s {\
  ...
  "exit_action": {\
    ...
    "action": {\
      ...
      "template": "function jodek:config/save/craft_music_discs {dialog_load_message:$(dialog_load_message), dialog_advancements:$(dialog_advancements)}"\
    }\
  },\
  "columns": 1,\
  "actions": [\
    {\
      ...
      "action": {\
        ...
        "command": "function jodek:app/uninstall/craft_music_discs"\
      }\
    },\
    {\
      "label": "Modrinth",\
