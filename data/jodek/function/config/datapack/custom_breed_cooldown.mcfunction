$dialog show @s {\
  ...
  "exit_action": {\
    ...
    "action": {\
      ...
      "template": "function jodek:config/save/custom_breed_cooldown {dialog_load_message:$(dialog_load_message), dialog_advancements:$(dialog_advancements)}"\
    }\
  },\
  "columns": 1,\
  "actions": [\
    {\
      ...
      "action": {\
        ...
        "command": "function custom_breed_cooldown:config/dialog_config with storage custom_breed_cooldown:root data"\
      }\
    },\
    {\
      "label": {\
      ...
      "action": {\
        "type": "minecraft:run_command",\
        "command": "function jodek:app/uninstall/custom_breed_cooldown"\
      }\
    },\
    {\
      "label": "Modrinth",\
