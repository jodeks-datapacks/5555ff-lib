$dialog show @s {\
  ...
  "title": "Villagers Buy Ender Pearls",\
  "body": [\
    {\
  ...
  "exit_action": {\
    ...
    "action": {\
      ...
      "template": "function jodek:config/save/villagers_buy_ender_pearls {dialog_load_message:$(dialog_load_message), dialog_advancements:$(dialog_advancements)}"\
    }\
  },\
  "columns": 1,\
  "actions": [\
    ...
    {\
      ...
      "action": {\
        ...
        "url": "https://modrinth.com/datapack/villagers-buy-ender-pearls"\
      }\
    }\
  ]\
}