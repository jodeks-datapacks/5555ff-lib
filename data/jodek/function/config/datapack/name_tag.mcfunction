$dialog show @s {\
  ...
  "exit_action": {\
    ...
    "action": {\
      ...
      "template": "function jodek:config/save/name_tag {dialog_load_message:$(dialog_load_message), dialog_advancements:$(dialog_advancements)}"\
    }\
  },\
  "columns": 1,\
  "actions": [\
    {\
      ...
      "action": {\
        ...
        "command": "function jodek:app/uninstall/name_tag"\
      }\
    },\
    {\
      "label": "Modrinth",\
      "action": {\
        ...
        "url": "https://modrinth.com/datapack/name-tag"\
      }\
    }\
  ]\
}