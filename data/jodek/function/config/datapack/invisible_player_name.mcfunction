$dialog show @s {\
  ...
  "exit_action": {\
    ...
    "action": {\
      ...
      "template": "function jodek:config/save/invisible_player_name {dialog_load_message:$(dialog_load_message), dialog_advancements:$(dialog_advancements)}"\
    }\
  },\
  "columns": 1,\
  "actions": [\
    {\
      ...
      "action": {\
        ...
        "command": "function jodek:app/uninstall/invisible_player_name"\
      }\
    },\
    {\
      "label": "Modrinth",\
      "action": {\
        ...
        "url": "https://modrinth.com/datapack/invisible-player-name"\
      }\
    }\
  ]\
}