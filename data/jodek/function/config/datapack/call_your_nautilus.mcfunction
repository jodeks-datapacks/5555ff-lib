$dialog show @s {\
  ...
  "exit_action": {\
    ...
    "action": {\
      ...
      "template": "function jodek:config/save/call_your_nautilus {dialog_load_message:$(dialog_load_message), dialog_advancements:$(dialog_advancements)}"\
    }\
  },\
  "columns": 1,\
  "actions": [\
    {\
      ...
      "action": {\
        ...
        "command": "function call_your_nautilus:config/dialog_config with storage call_your_nautilus:root data"\
      }\
    },\
    {\
      "label": {\
      ...
      "action": {\
        "type": "minecraft:run_command",\
        "command": "function jodek:app/uninstall/call_your_nautilus"\
      }\
    },\
    {\
      "label": "Modrinth",\
