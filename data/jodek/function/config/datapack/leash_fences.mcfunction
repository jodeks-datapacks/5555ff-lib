$dialog show @s {\
  ...
  "exit_action": {\
    ...
    "action": {\
      ...
      "template": "function jodek:config/save/leash_fences {dialog_load_message:$(dialog_load_message), dialog_advancements:$(dialog_advancements)}"\
    }\
  },\
  "columns": 1,\
  "actions": [\
    {\
      ...
      "action": {\
        ...
        "command": "function jodek:app/uninstall/leash_fences"\
      }\
    },\
    {\
      "label": "Modrinth",\
