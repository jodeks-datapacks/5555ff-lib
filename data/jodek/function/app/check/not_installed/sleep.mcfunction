...
execute unless score &sleep_load_message jodek.config = &sleep_load_message jodek.config run scoreboard players set &sleep_load_message jodek.config 0
...
execute unless data storage jodek:root data.sleep.advancements run data modify storage jodek:root data.sleep.advancements set value 0
