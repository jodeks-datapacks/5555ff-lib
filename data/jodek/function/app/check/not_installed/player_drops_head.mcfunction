...
execute unless score &player_drops_head_load_message jodek.config = &player_drops_head_load_message jodek.config run scoreboard players set &player_drops_head_load_message jodek.config 0
...
execute unless data storage jodek:root data.player_drops_head.advancements run data modify storage jodek:root data.player_drops_head.advancements set value 0
