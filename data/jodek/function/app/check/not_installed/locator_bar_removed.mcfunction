...
execute unless score &locator_bar_removed_load_message jodek.config = &locator_bar_removed_load_message jodek.config run scoreboard players set &locator_bar_removed_load_message jodek.config 0
...
data modify storage jodek:root data.locator_bar_removed.status set value jodek.not_installed
data modify storage jodek:root data.locator_bar_removed.status_fallback set value "Not Installed"
data modify storage jodek:root data.locator_bar_removed.color set value red
