...
execute unless score &mob_heads_load_message jodek.config = &mob_heads_load_message jodek.config run scoreboard players set &mob_heads_load_message jodek.config 0
