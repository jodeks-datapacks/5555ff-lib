...
execute unless score &swift_flight_load_message jodek.config = &swift_flight_load_message jodek.config run scoreboard players set &swift_flight_load_message jodek.config 0
