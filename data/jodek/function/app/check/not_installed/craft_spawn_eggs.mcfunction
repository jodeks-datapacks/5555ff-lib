...
execute unless score &craft_spawn_eggs_load_message jodek.config = &craft_spawn_eggs_load_message jodek.config run scoreboard players set &craft_spawn_eggs_load_message jodek.config 0
