...
execute unless score &call_your_nautilus_load_message jodek.config = &call_your_nautilus_load_message jodek.config run scoreboard players set &call_your_nautilus_load_message jodek.config 0
...
execute unless data storage jodek:root data.call_your_nautilus.advancements run data modify storage jodek:root data.call_your_nautilus.advancements set value 0
