...
execute unless score &copper_golem_hats_load_message jodek.config = &copper_golem_hats_load_message jodek.config run scoreboard players set &copper_golem_hats_load_message jodek.config 0
