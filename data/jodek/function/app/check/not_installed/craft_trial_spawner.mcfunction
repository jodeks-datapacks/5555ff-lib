...
execute unless score &craft_trial_spawner_load_message jodek.config = &craft_trial_spawner_load_message jodek.config run scoreboard players set &craft_trial_spawner_load_message jodek.config 0
