...
execute unless score &custom_breed_cooldown_load_message jodek.config = &custom_breed_cooldown_load_message jodek.config run scoreboard players set &custom_breed_cooldown_load_message jodek.config 0
