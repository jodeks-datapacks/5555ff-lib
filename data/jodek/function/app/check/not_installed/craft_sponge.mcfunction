...
execute unless score &craft_sponge_load_message jodek.config = &craft_sponge_load_message jodek.config run scoreboard players set &craft_sponge_load_message jodek.config 0
...
execute unless data storage jodek:root data.craft_sponge.advancements run data modify storage jodek:root data.craft_sponge.advancements set value 0
