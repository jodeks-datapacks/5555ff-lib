...
execute unless score &no_creeper_grief_load_message jodek.config = &no_creeper_grief_load_message jodek.config run scoreboard players set &no_creeper_grief_load_message jodek.config 0
...
execute unless data storage jodek:root data.no_creeper_grief.advancements run data modify storage jodek:root data.no_creeper_grief.advancements set value 0
