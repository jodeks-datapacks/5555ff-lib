...
execute unless score &craft_elytra_load_message jodek.config = &craft_elytra_load_message jodek.config run scoreboard players set &craft_elytra_load_message jodek.config 0
...
execute unless data storage jodek:root data.craft_elytra.advancements run data modify storage jodek:root data.craft_elytra.advancements set value 0
