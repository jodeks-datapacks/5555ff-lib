...
execute unless score &villagers_buy_ender_pearls_load_message jodek.config = &villagers_buy_ender_pearls_load_message jodek.config run scoreboard players set &villagers_buy_ender_pearls_load_message jodek.config 0
