...
execute unless score &show_dimension_in_name_load_message jodek.config = &show_dimension_in_name_load_message jodek.config run scoreboard players set &show_dimension_in_name_load_message jodek.config 0
...
execute unless data storage jodek:root data.show_dimension_in_name.advancements run data modify storage jodek:root data.show_dimension_in_name.advancements set value 0
