...
execute unless score &craft_enchanted_golden_apple_load_message jodek.config = &craft_enchanted_golden_apple_load_message jodek.config run scoreboard players set &craft_enchanted_golden_apple_load_message jodek.config 0
...
execute unless data storage jodek:root data.craft_enchanted_golden_apple.advancements run data modify storage jodek:root data.craft_enchanted_golden_apple.advancements set value 0
