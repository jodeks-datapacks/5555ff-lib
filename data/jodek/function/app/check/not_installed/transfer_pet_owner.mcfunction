...
execute unless score &transfer_pet_owner_load_message jodek.config = &transfer_pet_owner_load_message jodek.config run scoreboard players set &transfer_pet_owner_load_message jodek.config 0
