...
execute unless score &too_expensive_removed_load_message jodek.config = &too_expensive_removed_load_message jodek.config run scoreboard players set &too_expensive_removed_load_message jodek.config 0
