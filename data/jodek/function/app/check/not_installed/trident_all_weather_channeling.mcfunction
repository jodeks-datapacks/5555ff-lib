...
execute unless score &trident_all_weather_channeling_load_message jodek.config = &trident_all_weather_channeling_load_message jodek.config run scoreboard players set &trident_all_weather_channeling_load_message jodek.config 0
execute unless data storage jodek:root data.trident_all_weather_channeling.load_message run data modify storage jodek:root data.trident_all_weather_channeling.load_message set value 0
execute unless data storage jodek:root data.trident_all_weather_channeling.advancements run data modify storage jodek:root data.trident_all_weather_channeling.advancements set value 0
