scoreboard players set &better_cutter jodek.installed 1

data modify storage jodek:root data.better_cutter.installed set value 1
...
data modify storage jodek:root data.better_cutter.status set value jodek.installed
