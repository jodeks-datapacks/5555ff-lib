scoreboard players set &mob_heads jodek.installed 1

data modify storage jodek:root data.mob_heads.installed set value 1
...
data modify storage jodek:root data.mob_heads.status set value jodek.installed
