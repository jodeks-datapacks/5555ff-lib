...
execute store result score latest_position_x call_your.position run data get storage call_your_horse:root data.horse_UUID_latest_position_x
execute store result score latest_position_z call_your.position run data get storage call_your_horse:root data.horse_UUID_latest_position_z
