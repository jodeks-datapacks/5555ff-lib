execute if score @s call_your.raycast_hit matches 0 positioned ~-0.05 ~-0.05 ~-0.05 as @e[predicate=jodek:call_your/can_be_called,tag=!call_your.riding_ray,sort=nearest] run function jodek:api/call_your/raycast/check_hit_entity
